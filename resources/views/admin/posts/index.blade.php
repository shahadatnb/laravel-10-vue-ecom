...
<div class="card">
    <div class="card-header">
		<div class="row">
			<div class="col-2">
				<a href="{{ route('posts.create').'?type='.$posttype['postType'] }}" class="btn btn-primary btn-sm">Create New {{ $posttype['postType'] }}</a>
			</div>
        ...
        <table class="table">
			...
			@foreach($posts as $post)
				<tr>
					...
					@endif
					<td>{{ CustomHelper::prettyDate($post->created_at) }}</td>
					<td>
						<div class="btn-group">
