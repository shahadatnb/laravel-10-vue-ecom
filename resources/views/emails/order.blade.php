													...
													<tr>
														<td valign="top" style="padding: 48px 48px 32px;">
															<div id="body_content_inner" style='color: #636363; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%; text-align: left;'>
																	...
																	<table class="td" cellspacing="0" cellpadding="6" border="1" style="color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
																		...
																		<tbody>
																						...
																						<tr class="order_item">
																								...
																								{{ $item->qty_ordered }}</td>
																								<td class="td" style="color: #636363; border: 1px solid #e5e5e5; padding: 12px; text-align: left; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
																										<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">{{config('settings.currency')}}</span>{{$item->total}}</span>		</td>
																						</tr>
																						@endforeach
																		...
																		<tfoot>
																						...
																						<td class="td" style="color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left; border-top-width: 4px;"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">{{config('settings.currency')}}</span>{{$order->sub_total}}</span></td>
																					</tr>
																										<tr>
																...
																<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">{{config('settings.currency')}}</span>{{$order->shipping_amount}}</span> <small class="shipped_via">via Flat rate</small>
																</td>
																					</tr>
																					{{-- <tr>
																					...
																					<tr>
																						...
																						<td class="td" style="color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">{{config('settings.currency')}}</span>{{$order->amount}}</span></td>
																					</tr>
																							</tfoot>
																	</table>
																</div>
